    ...
    <div className="bg-background text-on-background font-body min-h-screen flex flex-col">
      ...
      <nav className="fixed top-0 w-full z-50 flex justify-between items-center px-12 py-6 bg-[#131313]/60 backdrop-blur-xl">
        <Link to="/" className="flex items-center space-x-4 group">
          <img src="/naorobi.svg" alt="Naorobi Logo" className="h-20 w-auto group-hover:scale-105 transition-transform duration-300" />
          <span className="text-2xl font-headline tracking-widest text-[#E5E2E1]">NAOROBI</span>
        </Link>
      ...
      <footer className="w-full py-12 border-t border-[#4D4635]/20 bg-[#131313] flex flex-col items-center justify-center space-y-6">
        ...
        <div className="flex space-x-8">
          <a className="font-label text-[11px] tracking-widest uppercase text-[#CECECE] hover:text-[#D4AF37] transition-colors" href="https://www.instagram.com/">Instagram</a>
          <a className="font-label text-[11px] tracking-widest uppercase text-[#CECECE] hover:text-[#D4AF37] transition-colors" href="https://www.linkedin.com/">LinkedIn</a>
